...
<body>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="kriterler.php" class="btn btn-outline-primary">
                        ...
                        <nav>
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                    <a class="page-link" href="degerlendirme_liste.php?sayfa=<?= $page-1 ?>&ay=<?= $ay ?>&yil=<?= $yil ?>&search=<?= urlencode($search) ?>">
                                        Önceki
                                    </a>
                                </li>
                                ...
                                <?php for($i = 1; $i <= $total_pages; $i++): ?>
                                    <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                                        <a class="page-link" href="degerlendirme_liste.php?sayfa=<?= $i ?>&ay=<?= $ay ?>&yil=<?= $yil ?>&search=<?= urlencode($search) ?>">
                                            <?= $i ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
    ...
    function selectPersonnel(id, evaluated) {
     ...
     window.location.href = `degerlendirme_form.php?personel_id=${id}&ay=<?= $ay ?>&yil=<?= $yil ?>`;
    }
    ...
    function clearSearch() {
        window.location.href = '?ay=<?= $ay ?>&yil=<?= $yil ?>';
    }
    </script>
