                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item dropdown hover-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboards">
                            <a href="index.php" class="dropdown-item">Dashboard 1 22</a>
                            <a href="dashboard-2.php" class="dropdown-item">Dashboard 2</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown hover-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <a href="taskboard.php" class="dropdown-item">Taskboard</a>
                            <a href="todo.php" class="dropdown-item">Todo</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="topnav-page">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <a href="pages-about.php" class="dropdown-item">About Us</a>
                                            <a href="pages-contact.php" class="dropdown-item">Contact</a>
                                            <a href="pages-companies.php" class="dropdown-item">Companies</a>
                                            <a href="pages-members.php" class="dropdown-item">Members</a>
                                            <a href="pages-members-2.php" class="dropdown-item">Members 2</a>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a href="pages-email-template.php" class="dropdown-item">Email Template</a>
                                            <a href="pages-search-result.php" class="dropdown-item">Search Result</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <div class="dropdown-menu dropdown-menu-xl" aria-labelledby="topnav-ui-kit">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <a href="ui-collapse.php" class="dropdown-item">Collapse</a>
                                            <a href="ui-checkbox-radio.php" class="dropdown-item">Checkbox Radio</a>
                                        ...
                                        <div class="col-lg-4">
                                            <a href="ui-ratios.php" class="dropdown-item">Ratios</a>
                                            <a href="ui-ribbons.php" class="dropdown-item">Ribbons</a>
                                            <a href="ui-scrollspy.php" class="dropdown-item">Scrollspy</a>
                            ...
                            <div class="dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-extended-ui">
                                    ...
                                    <a href="extended-sweetalerts.php" class="dropdown-item">Sweetalerts</a>
                                    <a href="extended-tiles.php" class="dropdown-item">Tiles</a>
                                    <a href="extended-nestable.php" class="dropdown-item">Nestable</a>
                                    <a href="extended-filemanager.php" class="dropdown-item">Filemanager</a>
                                    ...
                                    <a href="extended-lightbox.php" class="dropdown-item">Lightbox</a>
                                    <a href="extended-slider.php" class="dropdown-item">Slider</a>
                                    <a href="extended-scrollbar.php" class="dropdown-item">Scrollbar</a>
                                    <a href="extended-tost.php" class="dropdown-item">Tosts</a>
                                    <a href="extended-tour.php" class="dropdown-item">Tour</a>
                            ...
                            <div class="dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    ...
                                    <a href="icons-simple-line.php" class="dropdown-item">Simple Line</a>
                                    <a href="icons-tabler.php" class="dropdown-item">Tabler Icons</a>
                                    <a href="icons-lucide.php" class="dropdown-item">Lucide</a>
                                    <a href="icons-iconify.php" class="dropdown-item">Solar Design</a>
                                </div>
                            </div>
                            <div class="dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    ...
                                    <a href="charts-google.php" class="dropdown-item">Google Chart</a>
                                    <a href="charts-echart.php" class="dropdown-item">Echart</a>
                                    <a href="charts-chartjs.php" class="dropdown-item">Chartjs</a>
                                    <a href="charts-peity.php" class="dropdown-item">Peity Chart</a>
                                    <a href="charts-chartist.php" class="dropdown-item">Chartist Chart</a>
                                    <a href="charts-c3.php" class="dropdown-item">C3 Chart</a>
                                    <a href="charts-sparkline.php" class="dropdown-item">Sparklines Chart</a>
                                    <a href="charts-knob.php" class="dropdown-item">Jquery Knob</a>
                                </div>
                            </div>
                            <div class="dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-forms">
                                    ...
                                    <a href="form-masks.php" class="dropdown-item">Form Masks</a>
                            ...
                            <div class="dropdown hover-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-tables">
                                    ...
                                    <a href="tables-foo-tables.php" class="dropdown-item">Foo Tables</a>
                                    <a href="tables-editable.php" class="dropdown-item">Editable</a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown hover-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            ...
                            <a href="layouts-full.php" class="dropdown-item" target="_blank">Full View</a>
