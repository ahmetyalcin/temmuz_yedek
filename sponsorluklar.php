        ...
        switch ($_POST['islem']) {
            case 'sponsorluk_ekle':
                ...
                if ($sonuc) {
                    ...
                    header("Location: sponsorluklar.php");
                    exit;
                } else {
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button type="button" class="btn btn-danger" title="Sil"
                                                    onclick="if(confirm('Bu sponsorluğu silmek istediğinizden emin misiniz?'))
                                                            window.location.href='sponsorluklar.php?action=delete&id=<?php echo $sponsorluk['id']; ?>'">
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="sponsorluklar.php" class="btn btn-secondary">İptal</a>
                    </div>
                </form>
            </div>
        </div>
