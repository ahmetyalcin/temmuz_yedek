...
if ($personel_id) {
    try {
        ...
        if (!$personel) {
            header("Location: degerlendirme_liste.php?mesaj=" . urlencode("Personel bulunamadı."));
            exit;
        }
...
if ($personel_id) {
    try {
        ...
        if ($stmt->rowCount() > 0) {
            header("Location: degerlendirme_liste.php?mesaj=" . 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($required_fields)) {
        ...
        try {
            ...
            $pdo->commit();
            header("Location: degerlendirme_liste.php?&mesaj=" . urlencode("Değerlendirme başarıyla kaydedildi."));
            exit;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <a href="degerlendirme_liste.php" class="btn btn-primary">
